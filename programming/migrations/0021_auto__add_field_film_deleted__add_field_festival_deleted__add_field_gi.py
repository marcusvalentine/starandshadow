...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Film.deleted'
        db.add_column(u'programming_film', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Festival.deleted'
        db.add_column(u'programming_festival', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Gig.deleted'
        db.add_column(u'programming_gig', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Season.deleted'
        db.add_column(u'programming_season', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Event.deleted'
        db.add_column(u'programming_event', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Meeting.deleted'
        db.add_column(u'programming_meeting', 'deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Film.deleted'
        db.delete_column(u'programming_film', 'deleted')

        # Deleting field 'Festival.deleted'
        db.delete_column(u'programming_festival', 'deleted')

        # Deleting field 'Gig.deleted'
        db.delete_column(u'programming_gig', 'deleted')

        # Deleting field 'Season.deleted'
        db.delete_column(u'programming_season', 'deleted')

        # Deleting field 'Event.deleted'
        db.delete_column(u'programming_event', 'deleted')

        # Deleting field 'Meeting.deleted'
        db.delete_column(u'programming_meeting', 'deleted')
