...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Film.featured'
        db.add_column('programming_film', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Festival.featured'
        db.add_column('programming_festival', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Gig.featured'
        db.add_column('programming_gig', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Season.featured'
        db.add_column('programming_season', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Event.featured'
        db.add_column('programming_event', 'featured', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Film.featured'
        db.delete_column('programming_film', 'featured')

        # Deleting field 'Festival.featured'
        db.delete_column('programming_festival', 'featured')

        # Deleting field 'Gig.featured'
        db.delete_column('programming_gig', 'featured')

        # Deleting field 'Season.featured'
        db.delete_column('programming_season', 'featured')

        # Deleting field 'Event.featured'
        db.delete_column('programming_event', 'featured')
