...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Film.oldFilmFormat'
        db.delete_column(u'programming_film', 'oldFilmFormat')


    def backwards(self, orm):
        # Adding field 'Film.oldFilmFormat'
        db.add_column(u'programming_film', 'oldFilmFormat',
                      self.gf('django.db.models.fields.CharField')(default='Unknown', max_length=15),
                      keep_default=False)
