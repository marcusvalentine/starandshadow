...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Film.season'
        db.alter_column(u'programming_film', 'season_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['programming.Season'], null=True, on_delete=models.SET_NULL))


    def backwards(self, orm):
        # Changing field 'Film.season'
        db.alter_column(u'programming_film', 'season_id', self.gf('django.db.models.fields.related.ForeignKey')(default=2, to=orm['programming.Season']))
    ...
    models = {
        ...
        u'programming.event': {
            ...
            'approval': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['organisation.Approval']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
