...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Programmer.photo'
        db.add_column('programming_programmer', 'photo', self.gf('django.db.models.fields.files.ImageField')(default='img/programmer/ron1-small.jpg', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Programmer.photo'
        db.delete_column('programming_programmer', 'photo')
