...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        # db.rename_column('programming_film', 'confirmed', 'confirmedFlag')
        # db.rename_column('programming_festival', 'confirmed', 'confirmedFlag')
        # db.rename_column('programming_gig', 'confirmed', 'confirmedFlag')
        # db.rename_column('programming_season', 'confirmed', 'confirmedFlag')
        # db.rename_column('programming_event', 'confirmed', 'confirmedFlag')

    def backwards(self, orm):
        pass
        # db.rename_column('programming_film', 'confirmedFlag', 'confirmed')
        # db.rename_column('programming_festival', 'confirmedFlag', 'confirmed')
        # db.rename_column('programming_gig', 'confirmedFlag', 'confirmed')
        # db.rename_column('programming_season', 'confirmedFlag', 'confirmed')
        # db.rename_column('programming_event', 'confirmedFlag', 'confirmed')
