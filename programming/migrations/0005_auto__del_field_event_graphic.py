...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Event.graphic'
        db.delete_column('programming_event', 'graphic')


    def backwards(self, orm):
        
        # Adding field 'Event.graphic'
        db.add_column('programming_event', 'graphic', self.gf('django.db.models.fields.files.ImageField')(default='gone', max_length=100, blank=True), keep_default=False)
