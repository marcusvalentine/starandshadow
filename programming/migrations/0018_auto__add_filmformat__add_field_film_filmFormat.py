...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilmFormat'
        db.create_table(u'programming_filmformat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal(u'programming', ['FilmFormat'])

        # Adding field 'Film.filmFormat'
        db.add_column(u'programming_film', 'filmFormat',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['programming.FilmFormat']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'FilmFormat'
        db.delete_table(u'programming_filmformat')

        # Deleting field 'Film.filmFormat'
        db.delete_column(u'programming_film', 'filmFormat_id')
    ...
    models = {
        ...
        u'programming.film': {
            ...
            'notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'oldFilmFormat': ('django.db.models.fields.CharField', [], {'default': "'Unknown'", 'max_length': '15'}),
            'picture': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fileupload.Picture']", 'null': 'True', 'blank': 'True'}),
            'private': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'programmer': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['programming.Programmer']"}),
