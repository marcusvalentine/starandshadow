...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('programming_event', 'picture', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fileupload.Picture'], null=True, blank=True), keep_default=False)
        if not db.dry_run:
    ...
    def backwards(self, orm):
        ...
        db.delete_column('programming_event', 'picture_id')
