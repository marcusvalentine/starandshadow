...
//            }
                ...
                imageClick: function (context, img) {
                    ...
                    var dragStop = function () {                    
                        if (imageResizeinProgress) {
                            ...
                            $(document).trigger('webkitresize-updatecrc', [methods.crc(context.$container.html())]);
                ...
                tableClick: function (context, tbl) {
                    ...
                    var dragStop = function () {
                        if (tableResizeinProgress) {
                            ...
                            $(document).trigger('webkitresize-updatecrc', [methods.crc(context.$container.html())]);
                            $(document).trigger('webkitresize-table-resized');
    ...
    $.fn.webkittdresize = function (options) {
        return this.each(function () {
            ...
            $(document).bind('webkitresize-table-resized', function () {
                methods.reset(context);
            });
