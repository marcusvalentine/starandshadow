...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fileupload_picture', (
            ...
            ('file', self.gf('django.db.models.fields.files.ImageField')(max_length=500)),
            ('slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=200, blank=True)),
        ))
