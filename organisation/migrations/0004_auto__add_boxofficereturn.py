...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('organisation_boxofficereturn', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('film', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['programming.Film'])),
            ('newMembers', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('membershipPrice', self.gf('django.db.models.fields.DecimalField')(default=1.0, max_digits=5, decimal_places=2)),
            ('normalTickets', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('normalPrice', self.gf('django.db.models.fields.DecimalField')(default=5.0, max_digits=5, decimal_places=2)),
            ('concessionTickets', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('concesionPrice', self.gf('django.db.models.fields.DecimalField')(default=3.5, max_digits=5, decimal_places=2)),
        ))
        db.send_create_signal('organisation', ['BoxOfficeReturn'])


    def backwards(self, orm):
        
        # Deleting model 'BoxOfficeReturn'
        db.delete_table('organisation_boxofficereturn')
