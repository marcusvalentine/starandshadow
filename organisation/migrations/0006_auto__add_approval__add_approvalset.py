...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('organisation_approval', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('approvalset', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['organisation.ApprovalSet'])),
            ('approver', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['programming.Programmer'])),
        ))
        db.send_create_signal('organisation', ['Approval'])

        # Adding model 'ApprovalSet'
        db.create_table('organisation_approvalset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('meeting', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['programming.Meeting'], unique=True)),
        ))
        db.send_create_signal('organisation', ['ApprovalSet'])


    def backwards(self, orm):
        # Deleting model 'Approval'
        db.delete_table('organisation_approval')

        # Deleting model 'ApprovalSet'
        db.delete_table('organisation_approvalset')
